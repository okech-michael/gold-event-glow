...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MC Maticha Events & Entertainment — Premium MC & Event Services" },
      {
        name: "description",
        content:
          "Professional MC services and complete event solutions for weddings, corporate events, funerals, birthdays and graduations. Bringing life to every celebration.",
      },
      { name: "author", content: "MC Maticha Events & Entertainment" },
      { name: "theme-color", content: "#0B0B0B" },
      { property: "og:title", content: "MC Maticha Events & Entertainment — Premium MC & Event Services" },
      {
        property: "og:description",
        content: "Bringing life to every celebration — premium MC and complete event services.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "MC Maticha Events & Entertainment — Premium MC & Event Services" },
      {
